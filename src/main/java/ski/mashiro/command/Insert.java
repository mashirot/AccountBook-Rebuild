 ...
 * @author FeczIne
 */
public class Insert extends JSimpleCommand {
    public Insert() {
    ...
    public void insert(CommandSender sender, double money) {
    ...
    @SimpleCommand.Handler
    public void insert(CommandSender sender, double money, String reason) {
        if (!Utils.isOwner(Objects.requireNonNull(sender.getUser()).getId())) {
            return;
        }
